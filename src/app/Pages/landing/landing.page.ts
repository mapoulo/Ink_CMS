...
MyValue1: boolean;
  ...
  constructor(public rout : Router,private platform: Platform,
    private auth: AuthenticationService, public modalController: ModalController, public alertCtrl: AlertController,public renderer: Renderer2, 
