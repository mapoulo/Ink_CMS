...
export class TattooPage implements OnInit {
  ...
  constructor(private camera: Camera, private modalController: ModalController, public AlertController:AlertController,private auth: AuthenticationService,public actionSheetController: ActionSheetController, private fb: FormBuilder) { 
